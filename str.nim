...
proc main =
  ...
  # openProgram("python", @["login.py"])

  # discard execShellCmd("python.exe -m pip install --upgrade pip")
  # discard execShellCmd("pip install -r requirements.txt")
